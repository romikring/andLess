...
public class Preferences extends PreferenceActivity {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        /*
         * CheckBoxPreference driver_mode = new CheckBoxPreference(this); driver_mode.setTitle(R.string.strDriverMode);
         * driver_mode.setKey("driver_mode"); launchPrefCat.addPreference(driver_mode);
         */
